				...
				<div class="card-body">
					...
					<div class="form-row">	
		                ...
		                <div class="form-group col-md-4">
		                  ...
		                  <input type="text" name="username" class="form-control" style="width: 100%;" required="true">
		                </div>

		                <div class="form-group col-md-4">
		                  <label>email</label>
		                  <input type="email" name="email" class="form-control" style="width: 100%;" required="true">
		                </div>
		            </div>
